  ...
  return (
    <div className="memory-search-page">
      ...
      <div className="results-section">
        {isSearching && (
          <div className="search-loading"><div className="memory-search-spinner"></div><p>Recherche en cours...</p></div>
        )}
        ...
        <div className="full-conversation-modal">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {isLoadingFull ? (
                <div className="modal-loading"><div className="memory-search-spinner"></div><p>Chargement...</p></div>
              ) : (
