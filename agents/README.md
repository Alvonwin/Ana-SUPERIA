# 🤖 ÉCOSYSTÈME D'AGENTS AUTONOMES ANA

Système complet d'agents autonomes qui tournent en arrière-plan pour assister Ana dans la gestion de la mémoire et du système ARCHON.
...
Double-cliquez sur:
```
E:\Mémoire Ana\START_AGENTS.bat
```

### Méthode 2: Ligne de commande

```bash
cd "E:/Mémoire Ana/agents"
...
2. Vérifier qu'on est dans le bon dossier: `cd "E:/Mémoire Ana/agents"`
...
- **hook_v3_ana.js** - Peut écouter événements agents
...
- **Architecture complète**: `E:/Mémoire Ana/03_METAMEMOIRE/ARCHITECTURE_AGENTS_AUTONOMES_COMPLETE.md`
