...
const GROUP_KEYWORDS = {
  web: ['météo', 'meteo', 'weather', 'température', 'heure', 'date', 'time', 'chercher', 'recherche', 'search', 'web', 'internet', 'wiki', 'wikipedia', 'ping', 'ip', 'dns', 'whois', 'http', 'requête', 'request', 'check url', 'vérifier url', 'url valide', 'url accessible'],
