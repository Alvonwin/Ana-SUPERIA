...
Ce fichier contient les notifications que je (Ana) veux partager avec toi de manière proactive.
...
`
  ...
  saveNotifications() {
    ...
    content += `Ce fichier contient les notifications que je (Ana) veux partager avec toi de manière proactive.\n\n`
    content += `---\n\n`
