...
class IntelligenceRouter {
  ...
  classifyTask(message, context = {}) {
    ...
    const toolsKeywords = [
      ...
      // Git tools
      'git', 'git status', 'git commit', 'git log', 'git branch', 'git diff', 'git stash', 'git pull', 'git push',
    ...
    const memoryKeywords = ['souviens', 'rappelle', 'dit', 'conversation', 'mémoire', 'historique', 'ma voiture', 'regarde', 'précédemment', 'avant', 'déjà', 'voiture', 'marque'];
