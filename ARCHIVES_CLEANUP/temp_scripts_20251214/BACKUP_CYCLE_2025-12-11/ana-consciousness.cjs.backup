...
EXPERTS DISPONIBLES:
- "tools": Lire fichiers (read_file), lister fichiers (list_files), exécuter commandes (run_shell), chercher mémoire (search_memory), INFOS SYSTÈME (get_cpu_usage, get_memory_usage, get_disk_usage, ping, etc.)
